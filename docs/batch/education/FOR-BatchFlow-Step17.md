...
운영 창구까지 갖췄습니다. 이제 심화 트랙의 졸업 시험이 남았습니다 —
요구사항만 받고, **어떤 무기(분할? skip? 멱등?)를 어디에 쓸지 스스로 판단**하는 것.

> "ACTIVE 회원 전원에게 캠페인 알림을 보내주세요. 한 명의 발송 실패가 전체를
> 막으면 안 되고, 재실행해도 중복 발송은 절대 안 됩니다."

**심화 Step 18: 제2 캡스톤 — 대량 알림 발송**입니다.
(잔여 참조: 모니터링 연동(50-Step 38·40), Quartz 클러스터는 00 문서로)
