...
- [x] Step 18(심화 캡스톤): 대량 알림 발송 Job — 파티셔닝+skip+자연 멱등 종합 (50-Step 47~50) — `47cb61d`

## Plan 5: 대량 데이터 성능 실습 (Step 19) — ✅ 완료

- [x] Step 19(심화): 대량 데이터 성능 실습 — 생성 전략/chunk 크기/커밋 수 측정 (50-Step 31~33) — `0611e1a`
