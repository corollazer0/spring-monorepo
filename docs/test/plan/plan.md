...
- [ ] spring-web-onboarding 커리큘럼 설계 (TestCraft 패턴 재사용)
- [ ] 현업 프로젝트에 `.claude/` 이식 + 적용 후기 → 스킬 보강
- [ ] (선택) Step 13 후보: 테스트 데이터 관리 심화(@Sql 전략, 대량 시드) 또는 RestDocs

## Plan 5. 심화 확장 — Step 13 ArchUnit + Step 14 REST Docs (2026-06-12 사용자 승인)
