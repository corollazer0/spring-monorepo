...
- **학습 기준 커리큘럼**: `docs/batch/curriculum/01-BatchFlow-Essential-Curriculum.md` (필수 Step 1~13 + 심화 14~19)
...
│   └── bulk/                        # 심화 Step 19 (성능 실습 — chunkSize 파라미터화)
...
│   └── answer/    # 모범답안 — 항상 통과
└── advanced/step14/ ~ step19/       # 심화 (14 병렬, 15 파티셔닝, 16 비동기, 17 JobOperator, 18 캡스톤2, 19 성능실습)
```
