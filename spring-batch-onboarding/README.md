...
- **심화**: Step 14~19 (멀티스레드/병렬, 파티셔닝, 비동기, JobOperator 운영, 대량 알림 제2 캡스톤, 성능 측정 실습)
...
| 문서 | 내용 |
|------|------|
| [필수 트랙 커리큘럼](../docs/batch/curriculum/01-BatchFlow-Essential-Curriculum.md) | 학습 철학, Step 1~19 지도, 50-Step 매핑 |
