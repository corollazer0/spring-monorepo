...
-- 댓글 시드 (Step 9 캡스톤용): 1번 글에 2건(등록순), 2번 글에 1건
INSERT INTO comment (post_id, writer, content) VALUES (1, 'writer2', '첫 번째 댓글입니다');
INSERT INTO comment (post_id, writer, content) VALUES (1, 'writer1', '두 번째 댓글입니다');
INSERT INTO comment (post_id, writer, content) VALUES (2, 'writer1', '다른 글의 댓글입니다');
